...
kobo_asset_uid <- Sys.getenv("KOBO_ASSET_UID")
kobo_export_settings_uid <- Sys.getenv("KOBO_EXPORT_SETTINGS_UID")
...
# ---------- Kobo API call ----------
kobo_url <- paste0(
  "https://kobo.fao.org/api/v2/assets/",
  kobo_asset_uid,
  "/export-settings/",
  kobo_export_settings_uid,
  "/data.csv"
)
